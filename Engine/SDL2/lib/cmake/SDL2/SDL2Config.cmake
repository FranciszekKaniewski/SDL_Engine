...
get_filename_component(PACKAGE_PREFIX_DIR "../../../../../../myGame/Engine/SDL" ABSOLUTE)
...
if(EXISTS "SDL2Targets.cmake")
  include("SDL2Targets.cmake")
  set(SDL2_SDL2_FOUND TRUE)
endif()
if(EXISTS "SDL2staticTargets.cmake")
  if(ANDROID)
    enable_language(CXX)
  endif()
  include("SDL2staticTargets.cmake")
  set(SDL2_SDL2-static_FOUND TRUE)
endif()
if(EXISTS "SDL2mainTargets.cmake")
  include("SDL2mainTargets.cmake")
  set(SDL2_SDL2main_FOUND TRUE)
endif()
if(EXISTS "SDL2testTargets.cmake")
  include("SDL2testTargets.cmake")
  set(SDL2_SDL2test_FOUND TRUE)
endif()


include("sdlfind.cmake")
